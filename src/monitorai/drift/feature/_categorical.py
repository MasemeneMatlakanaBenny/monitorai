...
from monitorai._urls import batch_drift_feature
...
class CategoricalFeatureDrift:
    ...
    def _response(self,feature:str):
        try:
            ...
            drift_request=BatchFeatureDriftSDKRequest(
            ...
            payload = {
            "ref_data": drift_request.ref_data.to_dict(orient="records"),
            "analysis_data": drift_request.analysis_data.to_dict(orient="records"),
            "feature": drift_request.feature,
            }
